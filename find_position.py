...
def find_first_best_improvement_for_request_group_2(vehicles_schedule, request_group, original_score=M,
    ...
    for ins_cons in insertion_constraints:
        ...
        insert_request_group(temp_schedule, temp_request_dict, request_group, current_vehicle, ins_cons)
        current_score = calc_request_group_opportunity_cost(temp_schedule, request_group)
