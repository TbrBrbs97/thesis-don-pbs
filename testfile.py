...
from solution_construct import generate_initial_solution, static_optimization, disturb_solution, select_random_request_groups
...
# print(room_for_insertion_at_node(initial_solution, 1, '1,0'))
...
# random_requests = select_random_request_groups(initial_solution, 4)
...
optimized_solution, new_positions = static_optimization(initial_solution, scores_dict, required_requests_per_it=2,
